...
from unittest.mock import Mock, patch, MagicMock # Fix: Import MagicMock
...
class TestJiraService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_safe_jira_api.get_myself.return_value = {"displayName": "AutomationBot"}
    ...
    def test_create_issue_delegates_and_prepares_fields(self, mock_prepare_fields):
        ...
        self.mock_safe_jira_api.create_issue.assert_called_once_with(prepared_fields_payload) 
    ...
    def test_create_issue_api_failure(self):
        ...
        with patch("src.services.jira_service.JiraService.prepare_jira_task_fields", return_value=prepared_fields_payload) as mock_prepare_fields_call:
            self.mock_safe_jira_api.create_issue.return_value = None

            result_key = self.jira_service.create_issue(mock_task, parent_key, "TestUser")
    ...
    def test_search_issues_by_jql_delegation(self):
        ...
        self.mock_safe_jira_api.search_issues.assert_called_once_with(jql_query, fields="key")
    ...
    def test_get_issue_type_name_by_id_success(self):
        ...
        self.mock_safe_jira_api.get_issue_type_details_by_id.return_value = mock_issue_type_details
        
        type_name = self.jira_service.get_issue_type_name_by_id("10000")
        
        self.assertEqual(type_name, "Epic")
        self.mock_safe_jira_api.get_issue_type_details_by_id.assert_called_once_with("10000")
    ...
    def test_get_issue_type_name_by_id_failure(self):
        ...
        self.mock_safe_jira_api.get_issue_type_details_by_id.assert_called_once_with("99999")
